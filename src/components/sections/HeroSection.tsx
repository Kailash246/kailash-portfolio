  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute top-16 sm:top-20 md:top-20 lg:top-18 xl:top-20 inset-x-0 flex items-center justify-center pointer-events-none z-10 px-4 sm:px-8 md:px-12"
      >
        <div className="w-full flex items-center justify-center gap-2 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10 tracking-tight whitespace-nowrap">
          {/* "KAILASH" - Clean architectural outline */}
          <span
            className="text-[12vw] sm:text-[11vw] md:text-[10vw] lg:text-[8.8vw] xl:text-[8.5vw] 2xl:text-[8.2vw] font-sans font-black uppercase leading-none select-none text-transparent"
            style={{
              WebkitTextStroke: isMobile ? '1.8px #111111' : '3px #111111',
          ...
          <span
            className="text-[12vw] sm:text-[11vw] md:text-[10vw] lg:text-[8.8vw] xl:text-[8.5vw] 2xl:text-[8.2vw] font-sans font-black uppercase leading-none select-none text-[#111111]"
            style={{
              letterSpacing: '-0.04em',
            }}
          >
      ...
      <div
        ...
        className="absolute bottom-0 left-1/2 -translate-x-1/2 z-20 h-[62vh] sm:h-[72vh] md:h-[78vh] lg:h-[84vh] xl:h-[88vh] max-h-[88vh] w-auto flex items-end justify-center pointer-events-auto cursor-pointer"
      >
      ...
      <div className="absolute left-4 sm:left-8 md:left-12 lg:left-16 xl:left-24 top-[24%] sm:top-[27%] lg:top-[52%] lg:-translate-y-1/2 z-30 max-w-[320px] sm:max-w-md md:max-w-lg lg:max-w-md text-left pointer-events-auto">
        <h2 className="text-xl sm:text-2xl lg:text-[1.85rem] font-sans font-extrabold text-[#111111] tracking-tight leading-tight">
          Student | Builder | Learner
        </h2>

        <p className="text-xs sm:text-sm text-[#4B5563] font-sans leading-relaxed mt-2 sm:mt-3 mb-3 sm:mb-4 font-normal">
        ...
        <div className="mb-4 sm:mb-5">
          <img
            ...
            className="h-8 sm:h-9 md:h-9.5 w-auto object-contain select-none filter contrast-105"
          />
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="group inline-flex items-center gap-2 px-6 sm:px-7 py-2.5 sm:py-3 rounded-full bg-[#111111] hover:bg-black text-white text-xs sm:text-sm font-semibold tracking-wide shadow-md hover:shadow-lg transition-all hover:scale-105 active:scale-95 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-black"
          >
